...
btnInfo.addEventListener("click", function () {
  const content = `  Веб-сторінка призначенна для розділу студентув на пари (хлопець + дівчина). \n  Задопомогою кнопки "Задати" можна випадковим чином утворювати пари з відповілними темами. \n  Також за допомогою кнопки "вивести" можна генерувати випадкові оцінки кожному студенту в табличці.`;
  return (code = showInfo(content));
});
